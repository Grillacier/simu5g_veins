...
/**
 * Class generated from <tt>src/veins_inet/VeinsInetSampleMessage.msg:34</tt> by opp_msgtool.
 * <pre>
 * //
...
class VeinsInetSampleMessage : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual const char * getMess() const;
    virtual void setMess(const char * mess);
};
